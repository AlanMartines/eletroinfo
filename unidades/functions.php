...
class adv{
  ...
  //
  public function getAllUnidades($inicio=null, $maximo=null, $pesquisa=null){
   try{
    $sql = "SELECT * FROM unidades WHERE descricao LIKE '%$pesquisa%' ORDER BY descricao ASC LIMIT $inicio, $maximo";
    //print $sql;
    $stm = $this->pdo->prepare($sql);   
    $stm->execute();   
  ...
  //
  //
  public function getTotalUnidades($pesquisa=null){
   try{
    $sql = "SELECT * FROM unidades WHERE descricao LIKE '%$pesquisa%' ORDER BY descricao ASC";
    //print $sql;
    $stm = $this->pdo->prepare($sql);   
    $stm->execute();   
