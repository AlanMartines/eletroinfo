...
//echo $link.'<br>'; 
$UrlUm = 'https://eletroinfo.tk/sistemas/login/login.php';
$UrlDois = 'https://www.eletroinfo.tk/sistemas/login/login.php';
//
...
$RECAPTCHA_V3_SECRET_KEY = '6LeNSbIZAAAAAIB3UHrg3c-EIiQnCwwgkNP6Cg3O';
$ch = curl_init();
