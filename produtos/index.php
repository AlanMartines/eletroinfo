...
<form class="text-center" id="pesquisa-form" method="post" action="javascript:void(0)">
    	...
    	<div class="col-md-4 text-right">
	    	<button type="button" class="btn btn-sm btn-primary add-produto"><i class="fas fa-plus"></i> Novo</a>
	    	<button type="button" class="btn btn-sm btn-secondary atualizar-produto"><i class="fas fa-sync-alt"></i> Atualizar</button>
    	</div>
    </div>
